...
Existing tools either fail to handle academic workflows (generic note-taking apps) or encourage poor academic practice (AI chatbots that generate plausible but source-free text).
...
- Not a cheating tool or essay generator
...
- Not a citation manager (though it integrates citation awareness)
